    ...
    <>
      <LCard className="card" variant="outlined">
        ...
        <LayerCardButtons>
          ...
          <ButtonIcon onClick={openColourChanger}>
          ...
          <ButtonIcon onClick={openSettingsMenu}>
            <SettingsIcon />
          </ButtonIcon>
          ...
          >
            <MenuItem key={uuid()} style={{ width: "50px", padding: "0px" }}>
              <ButtonIcon onClick={() => changeName()}>
                {<DriveFileRenameOutlineIcon />}
              </ButtonIcon>
            </MenuItem>
            <MenuItem key={uuid()} style={{ width: "50px", padding: "0px" }}>
              <ButtonIcon onClick={() => deleteLayer()}>
                {<DeleteForeverIcon />}
              </ButtonIcon>
            </MenuItem>
          </LCardDropDown>
